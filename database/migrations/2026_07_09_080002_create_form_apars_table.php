...
return new class extends Migration
{
    ...
    {
        Schema::create('form_apars', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('mengetahui_2_id')->nullable()->constrained('master_signers')->nullOnDelete();
    ...
    {
        Schema::dropIfExists('form_apars');
    }
};
