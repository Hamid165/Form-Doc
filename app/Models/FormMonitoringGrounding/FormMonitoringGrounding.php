...
class FormMonitoringGrounding extends Model
{
    use HasFactory;

    protected $table = 'form_monitoring_groundings';
    ...
    {
        return $this->hasMany(FormMonitoringGroundingItem::class, 'form_monitoring_grounding_id');
    }
