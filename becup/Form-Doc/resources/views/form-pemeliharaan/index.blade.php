                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-2">
                                        <a href="{{ route('form-pemeliharaan.show', $form) }}" class="text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 h-[36px] w-[36px] flex items-center justify-center rounded-lg transition-colors" title="Lihat Dokumen">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                        </a>
                                        <a href="{{ route('form-pemeliharaan.show', $form) }}?print=true" target="_blank" class="text-emerald-600 hover:text-emerald-900 bg-emerald-50 hover:bg-emerald-100 h-[36px] w-[36px] flex items-center justify-center rounded-lg transition-colors" title="Cetak / Lihat PDF">
                                        ...
                                        <form method="POST" action="{{ route('form-pemeliharaan.confirm', $form) }}" class="inline">
                                            @csrf @method('PATCH')
                                            <button type="submit" class="text-purple-600 hover:text-purple-800 bg-purple-50 hover:bg-purple-100 h-[36px] w-[36px] flex items-center justify-center rounded-lg transition-colors" title="Konfirmasi Selesai">
                                        ...
                                        <form method="POST" action="{{ route('form-pemeliharaan.destroy', $form) }}" class="inline"
                                            ...
                                            @csrf @method('DELETE')
                                            <button type="submit" class="text-red-500 hover:text-red-700 bg-red-50 hover:bg-red-100 h-[36px] w-[36px] flex items-center justify-center rounded-lg transition-colors" title="Hapus">
