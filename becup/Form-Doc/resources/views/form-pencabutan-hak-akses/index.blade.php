            ...
            <div class="flex-1 grid grid-cols-12 gap-4 items-center">
                ...
                <div class="col-span-2 flex justify-end items-center">
                    <div class="flex items-center gap-2">
                        <a href="{{ route('form-pencabutan-hak-akses.show', $form->id) }}" class="text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 h-[40px] w-[40px] flex items-center justify-center rounded-lg transition-colors" title="Lihat Dokumen">
                        ...
                        <a href="{{ route('form-pencabutan-hak-akses.show', $form->id) }}?print=true" target="_blank" class="text-emerald-600 hover:text-emerald-900 bg-emerald-50 hover:bg-emerald-100 h-[40px] w-[40px] flex items-center justify-center rounded-lg transition-colors" title="Cetak / Lihat PDF">
