...
Route::get('/formulir', function (\Illuminate\Http\Request $request) {
    ...
    foreach ($templates as $template) {
        ...
        elseif ($template->nama === 'Checklist Pemeliharaan UPS' || str_contains($template->nama, 'UPS')) {
...
// ==============================================================
Route::get('form-pemeliharaan-ups/template-items', [FormPemeliharaanUpsController::class, 'downloadTemplateItems'])->name('form-pemeliharaan-ups.template-items');
Route::post('form-pemeliharaan-ups/parse-excel', [FormPemeliharaanUpsController::class, 'parseExcel'])->name('form-pemeliharaan-ups.parse-excel');
