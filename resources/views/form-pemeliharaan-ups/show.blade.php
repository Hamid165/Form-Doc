...
<head>
    ...
    <title>Formulir Checklist Pemeliharaan UPS - {{ $form->no_ref }}</title>
...
<body>
    ...
    <div class="a4-container relative">
        ...
        <div class="info-section">
            ...
            <table class="small-info-table table-kiri" style="float: left; margin-bottom: 0;">
                <tr>
            ...
            <table class="small-info-table table-kanan" style="float: right; margin-bottom: 0;">
                <tr>
                    <td class="kolom-label-kanan" style="border: none;">NO. ID</td>
                    <td class="filled-data" style="border: none;">: {{ $form->nomor_inventaris ?: '(nomor inventaris UPS)' }}</td>
                </tr>
                <tr>
                    <td class="kolom-label-kanan" style="border: none;">LOKASI</td>
                    <td class="filled-data" style="border: none;">: {{ $form->lokasi ?: '(tempat keberadaan aset UPS)' }}</td>
                </tr>
            </table>
        ...
        <table class="main-table">
            ...
            <tbody>
                ...
                @endfor
                <tr>
                    <td colspan="6" class="eof-cell">*** Akhir dari Dokumen / End of File ***</td>
                </tr>
            </tbody>
        </table>
        </div>
        ...
        <div class="footer-section clearfix">
            <div class="signature-box">
                <p>Yogyakarta, <span>{{ $form->kota_tanggal ? (\Carbon\Carbon::hasFormat($form->kota_tanggal, 'Y-m-d') ? \Carbon\Carbon::parse($form->kota_tanggal)->locale('id')->translatedFormat('j F Y') : $form->kota_tanggal) : '................................' }}</span></p>
