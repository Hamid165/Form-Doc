...
<head>
    ...
    <style>
        ...
        /* Style khusus untuk TTD statis */
        .static-ttd-name { display: inline-block; text-align: center; border-bottom: 1px solid black; padding-bottom: 2px; }
...
<body>
    ...
    <div class="a4-container">
        ...
        <!-- TTD HALAMAN 1 (STATIS) -->
        <table style="width:100%; border-collapse:collapse; font-size:11px; text-align:center; margin-top:20px;">
            <tr>
                <td style="width:50%; vertical-align: top;">
                    <div style="padding: 5px; font-weight: bold; min-height: 30px;">
                        {!! nl2br(e($form->jabatan_pimpinan_unit_kerja ?? 'Pimpinan Unit Kerja')) !!}
                    </div>
                </td>

                <td style="width:50%; vertical-align: top;">
                    <div style="padding: 5px; font-weight: bold; min-height: 30px;">
                        {!! nl2br(e($form->jabatan_pimpinan_it ?? "Pimpinan IT Kantor Pusat/Daerah\n(Pengelola Aset TI)")) !!}
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding-top:60px;">
                    <div style="margin-bottom:8px;">
                        ( <span class="static-ttd-name" style="width:180px;">{{ $form->pimpinan_unit_kerja }}</span> )
                    </div>
                    <div style="margin-top:3px;">
                        NIPP. <span class="static-ttd-name" style="width:110px;">{{ $form->nipp_pimpinan_unit_kerja }}</span>
                    </div>
                </td>

                <td style="padding-top:60px;">
                    <div style="margin-bottom:8px;">
                        ( <span class="static-ttd-name" style="width:180px;">{{ $form->pimpinan_it }}</span> )
                    </div>
                    <div style="margin-top:3px;">
                        NIPP. <span class="static-ttd-name" style="width:110px;">{{ $form->nipp_pimpinan_it }}</span>
                    </div>
                </td>
            </tr>
        </table>
            ...
            <table style="width:300px; border-collapse:collapse; font-size:11px; text-align:center;">
                <tr>
                    <td style="border:1px solid black; padding:8px; font-weight:bold;">
                        {!! nl2br(e($form->jabatan_petugas_it ?? 'Petugas IT Stock Opname')) !!}
                    </td>
                </tr>
                <tr>
                    <td style="border:1px solid black; padding-top:65px; padding-bottom:10px;">
                        <div style="margin-bottom:8px;">
                            ( <span class="static-ttd-name" style="width:190px; font-weight:bold;">{{ $form->petugas_it }}</span> )
                        </div>
                        <div style="margin-top:3px;">
                            NIPP. <span class="static-ttd-name" style="width:110px;">{{ $form->nipp_petugas_it }}</span>
                        </div>
                    </td>
                </tr>
            </table>
...
<script>
    // Memicu trigger dialog print otomatis jika terdapat ?print=true pada URL
    const urlParams = new URLSearchParams(window.location.search);
    if (urlParams.has('print')) {
        setTimeout(function() {
            window.print();
        }, 500); // Penundaan agar CSS termuat sempurna sebelum dialog print terbuka
    }
</script>
