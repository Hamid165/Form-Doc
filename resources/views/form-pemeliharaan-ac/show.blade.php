...
<head>
    ...
    <title>Formulir Checklist Pemeliharaan AC - {{ $form->no_ref }}</title>
    ...
    <style>
        ...
        .kolom-label-kanan {
            width: 99px; /* Lebar khusus kolom tulisan "ID AC" */
        }
        .small-info-table td {
            border: 1px solid black;
            padding: 2px 5px;
...
<body>
    ...
    <div class="a4-container relative">
        ...
        <div class="no-print" style="margin-bottom: 20px; text-align: right; display: flex; justify-content: flex-end; gap: 10px;">
            <a href="{{ route('form-pemeliharaan-ac.index') }}" class="btn-kembali">Kembali</a>
        </div>
        ...
        <div class="info-section">
            ...
            <table class="small-info-table table-kanan">
                <tr>
                    ...
                    <td class="filled-data" style="border: none;">: {{ $form->id_ac ?: '(nomor ID aset AC)' }}</td>
                </tr>
                <tr>
                    <td class="kolom-label-kanan" style="border: none;">LOKASI</td>
                    <td class="filled-data" style="border: none;">: {{ $form->lokasi ?: '(tempat keberadaan aset AC)' }}</td>
                </tr>
            </table>
        </div>
        ...
        <div style="border: 1px solid black; padding: 6px; margin-top: 12px; min-height: 40px; font-size: 10px;">
            <strong>Catatan :</strong> {!! nl2br(e($form->catatan ?: '')) !!}
        </div>
